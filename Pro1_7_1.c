	...
	//	Berker ÖNER 150122018
		...
		/*		Deðerlerin medyanlarýný hesaplayabildim fakat yazdýrýrken bir kayma oldu ve bunu çözemedim.
			Çýktýda deðerler farklý olmuyor sadece bir medyanýn çýktýsý farklý satýrda oluyor.				*/
